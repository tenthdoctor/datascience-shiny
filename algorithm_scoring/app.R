source('/Users/nallav8/Documents/Projects/DSaaS_Modules/algorithm_scoring/init.R',local = T)
...
ui <- bootstrapPage(useShinyjs(),
                    ...
                    dashboardPage(#skin = 'red',
                      dashboardHeader(title = HTML(paste(icon('cubes'),'Algorithm Scoring'))
                      ),
                      dashboardSidebar(
                        sidebarMenu(
                        ...
                        absolutePanel(
                          ...
                          width='100%',
                          height='auto',
                          a(icon('github fa-2x'),href='https://github.com/tenthdoctor/shiny-datascience',target='_blank')
                        )                  
                      ),
                      dashboardBody(
                        tabItems(
